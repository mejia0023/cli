...
--
-- NOTA: las recetas se asignan al medico con medico_uid = '611a93f6-eb88-46b4-89fc-595a7746ec41'.
...
--   WHERE medico_uid = '611a93f6-eb88-46b4-89fc-595a7746ec41';
...
INSERT INTO receta (id, paciente_id, medico_nombre, medico_uid, diagnostico, fecha_emision, controlado, hash_documento, blockchain_tx, blockchain_id, estado, created_at, updated_at) VALUES
    ...
    ('eeee0007-eeee-0007-eeee-000000000007', 'aaaa1111-aaaa-1111-aaaa-111111111111', 'Dr. Juan Perez', '611a93f6-eb88-46b4-89fc-595a7746ec41', 'Sinusitis bacteriana',                NOW() - INTERVAL '15 days',  FALSE, NULL, NULL, NULL, 'DISPENSADA', NOW() - INTERVAL '15 days', NOW() - INTERVAL '14 days'),
    ('eeee0008-eeee-0008-eeee-000000000008', 'aaaa2222-aaaa-2222-aaaa-222222222222', 'Dr. Juan Perez', '611a93f6-eb88-46b4-89fc-595a7746ec41', 'Hipertension grado II',               NOW() - INTERVAL '12 days',  FALSE, NULL, NULL, NULL, 'DISPENSADA', NOW() - INTERVAL '12 days', NOW() - INTERVAL '11 days'),
    ('eeee0009-eeee-0009-eeee-000000000009', 'aaaa1111-aaaa-1111-aaaa-111111111111', 'Dr. Juan Perez', '611a93f6-eb88-46b4-89fc-595a7746ec41', 'Faringoamigdalitis aguda',            NOW() - INTERVAL '8 days',   FALSE, NULL, NULL, NULL, 'DISPENSADA', NOW() - INTERVAL '8 days',  NOW() - INTERVAL '7 days'),
    ('eeee0010-eeee-0010-eeee-000000000010', 'aaaa2222-aaaa-2222-aaaa-222222222222', 'Dr. Juan Perez', '611a93f6-eb88-46b4-89fc-595a7746ec41', 'Control hipertension',                NOW() - INTERVAL '5 days',   FALSE, NULL, NULL, NULL, 'DISPENSADA', NOW() - INTERVAL '5 days',  NOW() - INTERVAL '4 days'),
    -- 2 ANULADAS
    ('eeee0011-eeee-0011-eeee-000000000011', 'aaaa1111-aaaa-1111-aaaa-111111111111', 'Dr. Juan Perez', '611a93f6-eb88-46b4-89fc-595a7746ec41', 'Bronquitis (paciente no llego)',      NOW() - INTERVAL '7 days',   FALSE, NULL, NULL, NULL, 'ANULADA',    NOW() - INTERVAL '7 days',  NOW() - INTERVAL '6 days'),
    ('eeee0012-eeee-0012-eeee-000000000012', 'aaaa2222-aaaa-2222-aaaa-222222222222', 'Dr. Juan Perez', '611a93f6-eb88-46b4-89fc-595a7746ec41', 'Error en prescripcion',               NOW() - INTERVAL '3 days',   FALSE, NULL, NULL, NULL, 'ANULADA',    NOW() - INTERVAL '3 days',  NOW() - INTERVAL '2 days')
...
INSERT INTO factura (id, numero, paciente_id, usuario_id, fecha, subtotal, descuento, total, metodo_pago, estado, created_at, updated_at) VALUES
    ...
    ('ffff0002-ffff-0002-ffff-000000000002', 'F-2026-000011', 'aaaa2222-aaaa-2222-aaaa-222222222222', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '28 days',  21.00,  0,   21.00, 'EFECTIVO',     'PAGADA',    NOW() - INTERVAL '28 days', NOW() - INTERVAL '28 days'),
    ...
    ('ffff0011-ffff-0011-ffff-000000000011', 'F-2026-000020', 'aaaa1111-aaaa-1111-aaaa-111111111111', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '15 days',  75.00,  0,   75.00, 'EFECTIVO',     'PAGADA',    NOW() - INTERVAL '15 days', NOW() - INTERVAL '15 days'),
    ('ffff0012-ffff-0012-ffff-000000000012', 'F-2026-000021', 'aaaa1111-aaaa-1111-aaaa-111111111111', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '14 days',  32.50,  0,   32.50, 'TARJETA',      'PAGADA',    NOW() - INTERVAL '14 days', NOW() - INTERVAL '14 days'),
    ...
    ('ffff0014-ffff-0014-ffff-000000000014', 'F-2026-000023', 'aaaa2222-aaaa-2222-aaaa-222222222222', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '12 days',  72.00,  0,   72.00, 'TARJETA',      'PAGADA',    NOW() - INTERVAL '12 days', NOW() - INTERVAL '12 days'),
    ...
    ('ffff0016-ffff-0016-ffff-000000000016', 'F-2026-000025', 'aaaa1111-aaaa-1111-aaaa-111111111111', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '10 days', 180.00,  0,  180.00, 'TARJETA',      'PAGADA',    NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days'),
    ...
    ('ffff0018-ffff-0018-ffff-000000000018', 'F-2026-000027', 'aaaa1111-aaaa-1111-aaaa-111111111111', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '8 days',   75.00,  0,   75.00, 'EFECTIVO',     'PAGADA',    NOW() - INTERVAL '8 days',  NOW() - INTERVAL '8 days'),
    ...
    ('ffff0021-ffff-0021-ffff-000000000021', 'F-2026-000030', 'aaaa2222-aaaa-2222-aaaa-222222222222', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '5 days',   72.00,  0,   72.00, 'TRANSFERENCIA','PAGADA',    NOW() - INTERVAL '5 days',  NOW() - INTERVAL '5 days'),
    ('ffff0022-ffff-0022-ffff-000000000022', 'F-2026-000031', 'aaaa1111-aaaa-1111-aaaa-111111111111', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '4 days',   30.00,  0,   30.00, 'QR',           'PAGADA',    NOW() - INTERVAL '4 days',  NOW() - INTERVAL '4 days'),
    ...
    ('ffff0024-ffff-0024-ffff-000000000024', 'F-2026-000033', 'aaaa2222-aaaa-2222-aaaa-222222222222', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '2 days',   58.00,  5,   53.00, 'TARJETA',      'PAGADA',    NOW() - INTERVAL '2 days',  NOW() - INTERVAL '2 days'),
    ...
    ('ffff0029-ffff-0029-ffff-000000000029', 'F-2026-000038', 'aaaa2222-aaaa-2222-aaaa-222222222222', '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '5 days',   25.00,  0,   25.00, 'TARJETA',      'ANULADA',   NOW() - INTERVAL '5 days',  NOW() - INTERVAL '4 days'),
    -- 1 PENDIENTE
    ('ffff0030-ffff-0030-ffff-000000000030', 'F-2026-000039', 'aaaa2222-aaaa-2222-aaaa-222222222222', '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '1 days',   65.00,  0,   65.00, 'EFECTIVO',     'PENDIENTE', NOW() - INTERVAL '1 days',  NOW() - INTERVAL '1 days')
ON CONFLICT (id) DO NOTHING;
